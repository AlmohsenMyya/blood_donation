...
class _NearbyRequestsScreenState extends ConsumerState<NearbyRequestsScreen> {
  ...
  void initState() {
    super.initState();
    // Get city + blood group from the cached profile stream — no extra Firestore call.
    ref.listenManual(
      userProfileProvider,
      (_, next) {
        ...
        if (city != null && bg != null &&
            (city != _userCity || bg != _userBloodGroup)) {
          _userCity = city;
          _userBloodGroup = bg;
  ...
  Future<void> _fetchNearbyRequests() async {
    ...
    try {
      ...
      debugPrint('NearbyRequestsScreen._fetchNearbyRequests: $e');
      if (mounted) setState(() => _loading = false);
    }
  }
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final bool isPerfect =
                          request['bloodGroup'] == _userBloodGroup;
                            ...
                            children: [
                              ...
                              _buildInfoRow(Icons.local_hospital,
                                  ...
                                  request['hospital'] ??
                                      ...
                                      ''),
                              _buildInfoRow(Icons.location_on, l10n.city,
                                  request['city'] ?? ''),
