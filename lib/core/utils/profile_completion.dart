  ...
  static List<ProfileSection> getSections(Map<String, dynamic> data) {
    return [
      ProfileSection(
        ...
        subtitleEn: 'Name, phone, city, blood group, date of birth',
        subtitleAr: 'الاسم، الهاتف، المدينة، زمرة الدم، تاريخ الميلاد',
        weight: basicWeight,
      ...
      ProfileSection(
        ...
        titleAr: 'السجل الطبي',
        subtitleEn: 'Last donation, diseases, allergies, medications',
        subtitleAr: 'تاريخ آخر تبرع، الأمراض، الحساسية، الأدوية',
      ...
      ProfileSection(
        ...
        subtitleEn: 'Name, phone and relationship',
        subtitleAr: 'اسم وهاتف وصلة القرابة',
